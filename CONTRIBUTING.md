...
The Shadow project operates an open contributor model where anyone is
...
The following applies to code changes to the Shadow project, and is not to be
confused with overall SHADOW Network Protocol consensus changes.

Whether a pull request is merged into Shadow rests with the project merge
...
Patches that change SHADOW consensus rules are considerably more involved than
...
Where a patch set proposes to change the SHADOW consensus, it must have been
...
The project leader is the release manager for each Shadow release.
