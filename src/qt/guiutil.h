...
/** Utility functions used by the SHADOW Qt UI.
 */
namespace GUIUtil
{
...
// Render SHADOW addresses in monospace font
...
// Parse "shadow:" URI into recipient object, return true on successful parsing
