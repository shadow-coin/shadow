...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeShadow = new QSpinBox(tabMain);
        anonymizeShadow->setObjectName(QStringLiteral("anonymizeShadow"));
        anonymizeShadow->setMinimum(100);
        anonymizeShadow->setMaximum(100000);
        anonymizeShadow->setSingleStep(100);
        anonymizeShadow->setValue(1000);

        horizontalLayout->addWidget(anonymizeShadow);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start SHADOW after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start SHADOW on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of SHADOW to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the SHADOW client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the SHADOW network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting SHADOW.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/shadowcoin/shadowcoin-translations", 0));
