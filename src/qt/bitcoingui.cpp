...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SHADOW address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and shadow: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Shadow"), this);
    aboutAction->setStatusTip(tr("Show information about Shadow"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SHADOW"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SHADOW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SHADOW addresses"));
    ...
    openAction->setStatusTip(tr("Open a SHADOW: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Shadow help message to get a list with possible SHADOW command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Shadow client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SHADOW network", "", count));
}
...
{
    QString strTitle = tr("Shadow"); // default title
