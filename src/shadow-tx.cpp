...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Shadow shadow-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  shadow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shadow transaction") + "\n" +
                               "  shadow-tx [options] -create [commands]   " + _("Create hex-encoded shadow transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded shadow transaction
