...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Shadow features */
        {"shadow", "masternode", &masternode, true, true, false},
        {"shadow", "listmasternodes", &listmasternodes, true, true, false},
        {"shadow", "getmasternodecount", &getmasternodecount, true, true, false},
        {"shadow", "masternodeconnect", &masternodeconnect, true, true, false},
        {"shadow", "masternodecurrent", &masternodecurrent, true, true, false},
        {"shadow", "masternodedebug", &masternodedebug, true, true, false},
        {"shadow", "startmasternode", &startmasternode, true, true, false},
        {"shadow", "createmasternodekey", &createmasternodekey, true, true, false},
        {"shadow", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"shadow", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"shadow", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"shadow", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"shadow", "getmasternodescores", &getmasternodescores, true, true, false},
        {"shadow", "mnbudget", &mnbudget, true, true, false},
        {"shadow", "preparebudget", &preparebudget, true, true, false},
        {"shadow", "submitbudget", &submitbudget, true, true, false},
        {"shadow", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"shadow", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"shadow", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"shadow", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"shadow", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"shadow", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"shadow", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"shadow", "checkbudgets", &checkbudgets, true, true, false},
        {"shadow", "mnsync", &mnsync, true, true, false},
        {"shadow", "spork", &spork, true, true, false},
        {"shadow", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"shadow", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use shadowd, or the -server option to shadow-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> shadow-cli " + methodname + " " + args + "\n";
}
