...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0xa0458d5f10e0d0d6be7f285c92facaf200dea103a726b09b61260646995b1aac"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1529046330, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "vamos a por el oro";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1529046330;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20552486;

        hashGenesisBlock = genesis.GetHash();
        
        assert(hashGenesisBlock == uint256("0xa0458d5f10e0d0d6be7f285c92facaf200dea103a726b09b61260646995b1aac"));
        assert(genesis.hashMerkleRoot == uint256("0x2b6b4d84e16f10459ef27b7a7033388dcbc46708acf420a35cf47f4a87fa1a31"));

        vSeeds.push_back(CDNSSeedData("95.179.148.83","95.179.148.83"));
