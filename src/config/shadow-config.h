/* src/config/shadow-config.h.  Generated from shadow-config.h.in by configure.  */
/* src/config/shadow-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "Shadow Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Shadow Core 3.0.0"
