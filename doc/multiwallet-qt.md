...
In order to support loading of multiple wallets in shadow-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is shadow.cpp.
...
Changes to shadow.cpp
----------------------
shadow.cpp is the entry point into shadow-qt, and as such, will require some minor modifications to provide hooks for
