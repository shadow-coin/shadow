Shadow version 2.2.1 is now available from:

  <https://github.com/shadowcoin/shadow/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/shadowcoin/shadow/issues>

Compatibility
==============

Shadow is extensively tested on multiple operating systems using
...
Shadow should also work on most other Unix-like systems but is not
...
of Bitcoin that SHADOW was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/shadowcoin-translations/).
