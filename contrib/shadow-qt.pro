...
RESOURCES += src/qt/shadow.qrc src/qt/shadow_locale.qrc

TRANSLATIONS += src/qt/locale/shadow_bg.ts \
                src/qt/locale/shadow_de.ts \
                src/qt/locale/shadow_en.ts \
                src/qt/locale/shadow_es.ts \
                src/qt/locale/shadow_fi.ts \
                src/qt/locale/shadow_fr.ts \
                src/qt/locale/shadow_it.ts \
                src/qt/locale/shadow_ja.ts \
                src/qt/locale/shadow_pl.ts \
                src/qt/locale/shadow_pt.ts \
                src/qt/locale/shadow_ru.ts \
                src/qt/locale/shadow_sk.ts \
                src/qt/locale/shadow_sv.ts \
                src/qt/locale/shadow_vi.ts \
                src/qt/locale/shadow_zh_CN.ts \
                src/qt/locale/shadow_zh_TW.ts
